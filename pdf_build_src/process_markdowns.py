...
def correct_table(table, offset=[0.0, 0.0], debug=False):
    ...
    offset : list of int
        Offset that is used to adjust the correction of number of dashes in the first (offset[0])
        and second (offset[1]) columns by the number specified in percentage.
        Defaults to [0.0, 0.0].
    debug : bool
    ...
    new_table : list of list of str
        List of corrected lines of the input table with corrected number of dashes and aligned
        fences.
    ...
    # Computes an equal number of dashes per column based on the maximal number of characters
    # over the columns
            ...
            if file.endswith(".md") and file not in exclude_files:
                ...
                for line_nb, line in enumerate(content):
                    ...
                    if not table_mode and _contains_table_start(line, debug):
                        ...
                        # append each corrected row (line) to the content of the new
                        # markdown content
                        if is_end_of_table:
                            print(
                            ...
                            if corrected:
                                print(
                                    "    - Appended corrected table lines to the "
